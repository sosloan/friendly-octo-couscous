...
test-ada:
	...
	cd ada && gprbuild -P hft.gpr && obj/hft_test && obj/hft_compliance_test && obj/hft_integration_test && obj/hft_spark_test && obj/hft_ravenscar_test && obj/hft_spark_ravenscar_test && obj/hft_main
