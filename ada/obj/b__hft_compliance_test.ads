...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_hft_compliance_test" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#58463645#;
   pragma Export (C, u00001, "hft_compliance_testB");
   ...
   u00142 : constant Version_32 := 16#d22fc2e4#;
